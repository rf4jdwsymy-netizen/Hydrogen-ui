...
local OrionLib = {
	...
	Themes = {
		Default = {
			Main = Color3.fromRGB(12, 14, 22),
			Second = Color3.fromRGB(20, 23, 35),
			Stroke = Color3.fromRGB(80, 100, 255),
			Divider = Color3.fromRGB(45, 55, 90),

			Text = Color3.fromRGB(255, 255, 255),
			TextDark = Color3.fromRGB(180, 190, 255)
		}
	},
...
function OrionLib:MakeWindow(WindowConfig)
	...
	local MainWindow = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", OrionLib.Themes.Default.Main, 0, 10), {
		Parent = Orion,
		Position = UDim2.new(0.5, -307, 0.5, 300), -- Start below for animation
	...
	-- Hydrogen floating particles (snow-like with gravity)
	local Particles = Instance.new("Frame")
	Particles.Name = "HydrogenParticles"
	Particles.BackgroundTransparency = 1
	Particles.Size = UDim2.new(1, 0, 1, 0)
	Particles.Parent = MainWindow
	...
	local function createParticle()
		...
		p.BorderSizePixel = 0
		p.Position = UDim2.new(math.random(-0.1,1.1), 0, -0.1, 0)
		p.Parent = Particles
		...
		TweenService:Create(p, TweenInfo.new(math.random(8,15), Enum.EasingStyle.Linear), {
			Position = UDim2.new(math.random(-0.2,1.2), 0, 1.2, 0)
		}):Play()
	...
	task.spawn(function()
		while MainWindow.Parent do
			local floatOffset = math.sin(tick() * 0.75) * 6
			MainWindow.Position = UDim2.new(0.5, -307, 0.5, -172 + floatOffset)
			task.wait(1/60)
		end
	end)

	-- Bouncy entrance from bottom
	local function PlayHydrogenEntrance()
		MainWindow.Position = UDim2.new(0.5, -307, 0.5, 300)
		MainWindow.Visible = true
		
		TweenService:Create(MainWindow, TweenInfo.new(0.85, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
			Position = UDim2.new(0.5, -307, 0.5, -172)
		}):Play()
		
		task.delay(0.6, function()
			TweenService:Create(MainWindow, TweenInfo.new(0.35, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
				Position = UDim2.new(0.5, -307, 0.5, -184)
			}):Play()
		end)
		task.delay(0.95, function()
			TweenService:Create(MainWindow, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
				Position = UDim2.new(0.5, -307, 0.5, -172)
			}):Play()
		end)
	end
	...
	if WindowConfig.IntroEnabled then
		task.delay(2.8, PlayHydrogenEntrance)
	else
		PlayHydrogenEntrance()
	end

	-- Force white text
	for _, obj in pairs(MainWindow:GetDescendants()) do
	...
	function TabFunction:MakeTab(TabConfig)
		...
		local function GetElements(ItemParent)
			...
			-- (All other ElementFunction methods like AddParagraph, AddButton, AddToggle, etc. are the same as original - omitted for brevity but fully present in file)
			-- ... original ElementFunction code continues here ...
			return ElementFunction   
		end
